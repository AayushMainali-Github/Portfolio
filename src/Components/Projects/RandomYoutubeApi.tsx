...
const RandomYoutubeApi = () => {
  return (
    <div className="project">
      ...
      <div className="desc">
        Its a simple which can be used to fetch random videos from youtube. Users can send a GET request to get a random youtube video link and also can send a youtube video link
